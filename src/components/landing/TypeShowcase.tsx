            ...
            return (
              ...
              >
                <div className="flex justify-center gap-0.5 mb-1">
                  {code.replace(/-/g, '').split('').map((l, i) => (
                    <span key={i} className="w-8 h-9 bg-indigo-50 rounded-lg flex items-center justify-center text-base font-extrabold text-indigo-600 group-hover:bg-indigo-100">
                      {l}
                    </span>
                  ))}
                </div>
